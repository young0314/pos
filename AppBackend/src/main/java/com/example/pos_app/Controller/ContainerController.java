...
public class ContainerController {
    ...
    public ResponseEntity<Map<String, Object>> getContainerMonitoringData(
        ...
        ContainerResponseDTO containerResponseDTO = ContainerResponseDTO.fromEntity(container);
        ...
        sessionManager.saveContainerInfo(containerResponseDTO, request);
        ContainerResponseDTO sessionContainer = sessionManager.getContainerInfo(request);
