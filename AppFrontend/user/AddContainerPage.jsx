...
import AsyncStorage from '@react-native-async-storage/async-storage';
  ...
  const handleContainer = async () => {
    try {
      if (!containerOwner || !cargo || !containNumber || !destination) {
    ...
    //중복 체크
      ...
      const newContainer = { containerOwner, cargo, containNumber, destination };
      console.log("보낼 데이터:", newContainer);

      const response = await fetch('http://192.168.137.243:8080/container/register', {
        method: 'POST',
