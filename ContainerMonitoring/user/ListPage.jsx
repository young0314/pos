...
const styles = StyleSheet.create({
  ...
  headerTextContainer: {
    flexDirection: "row",
    alignItems: "center",  // 텍스트와 버튼을 수평으로 배치
    justifyContent: "space-between", // 텍스트와 버튼을 양쪽 끝으로 배치
    width: "100%",
  ...
  infoTextContainer: {
    flexDirection: 'column', // 컨테이너 번호와 번호를 세로로 배치
    fontSize: 16,
    width: "100%",
    paddingLeft: 10,
  ...
  addButton: {
    ...
    borderRadius: 10,
   // backgroundColor: "#EEE",
    alignItems: "center",  // 버튼 안의 아이콘을 중앙 정렬
    justifyContent: "center",
  },
